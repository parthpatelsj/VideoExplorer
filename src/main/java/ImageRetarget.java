...
public class ImageRetarget {
    ...
    public static void main(final String[] args) {
        ...
        ImageRetarget rn = new ImageRetarget(new GradientMagnitudeFunction());
        BufferedImage result = rn.retarget(image, 1740, 99);
        ...
        Set<Point> facePoints = fd.getFacePoints(src);
        System.out.println("Calculating energy.");
        img = energyFunction.transform(facePoints, img);
